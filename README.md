...
To replicate experiment 1, run table gen for all methods we then run table_gen.py to consolidate all results. For the result of experiments 3 and 4, please run other_exp.py
